...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if cachedData["currentHouse"] then
            local allowed = cachedData["currentHouse"]["displayLabel"] == ESX.PlayerData["character"]["firstname"] .. " " .. ESX.PlayerData["character"]["lastname"]
